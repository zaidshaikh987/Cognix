...
with open('LICENSE', 'w', encoding='utf-8') as f: f.write('MIT License\n\nCopyright (c) 2026 COGNIX Contributors\n')
with open('CONTRIBUTING.md', 'w', encoding='utf-8') as f: f.write('# Contributing to COGNIX\n\nSubmit PRs!\n')
with open('CODE_OF_CONDUCT.md', 'w', encoding='utf-8') as f: f.write('# Code of Conduct\n\nBe excellent to each other.\n')
  ...
  build:
    ...
    - name: Install dependencies
      run: |
        ...
        pip install -e .
"""
with open('.github/workflows/python-app.yml', 'w', encoding='utf-8') as f: f.write(workflow_content)

commands = [
    ['git', 'init'],
    ['git', 'add', '.'],
    ['git', 'commit', '-m', 'Initial open-source release with detailed README and Actions'],
    ['git', 'branch', '-M', 'main'],
    ['git', 'remote', 'add', 'origin', 'https://github.com/zaidshaikh987/Cognix.git'],
